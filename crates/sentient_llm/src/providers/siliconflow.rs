...
//!
//! SiliconFlow - Chinese AI inference platform
...
/// SiliconFlow provider - Chinese AI inference platform
...
impl SiliconFlowProvider {
    ...
    pub fn from_env() -> LlmResult<Self> {
        let api_key = std::env::var("SILICONFLOW_API_KEY")
            .map_err(|_| LlmError::Authentication("SILICONFLOW_API_KEY not set".into()))?;
        Self::new(api_key)
    }
}
...
impl LlmProvider for SiliconFlowProvider {
    ...
    fn models(&self) -> Vec<ModelInfo> {
        vec![
            ...
            ModelInfo {
                id: "Qwen/Qwen2.5-Math-72B-Instruct".into(),
                name: "Qwen 2.5 Math 72B".into(),
                provider: "SiliconFlow".into(),
                context_window: 128_000,
                max_output_tokens: 8_192,
                input_cost_per_1k: 0.0004,
            ...
            ModelInfo {
                id: "Qwen/Qwen2-VL-72B-Instruct".into(),
                name: "Qwen 2 VL 72B".into(),
                provider: "SiliconFlow".into(),
            ...
            ModelInfo {
                id: "internlm/internlm2_5-20b-chat".into(),
                name: "InternLM 2.5 20B".into(),
                provider: "SiliconFlow".into(),
                context_window: 32_000,
                max_output_tokens: 4_096,
                input_cost_per_1k: 0.0001,
            ...
            ModelInfo {
                id: "Yi-1.5-34B-Chat".into(),
                name: "Yi 1.5 34B".into(),
                provider: "SiliconFlow".into(),
...
mod tests {
    ...
    fn test_siliconflow_models() {
        let provider = SiliconFlowProvider::new("test-key").unwrap();
