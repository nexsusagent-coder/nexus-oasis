//! ─── FriendliAI Provider ───
//!
//! FriendliAI - GPU-optimized inference engine
//! https://friendli.ai
...
/// FriendliAI provider - GPU-optimized inference
...
impl FriendliAIProvider {
    ...
    pub fn from_env() -> LlmResult<Self> {
        let api_key = std::env::var("FRIENDLI_TOKEN")
            .map_err(|_| LlmError::Authentication("FRIENDLI_TOKEN not set".into()))?;
        Self::new(api_key)
    }
}
...
impl LlmProvider for FriendliAIProvider {
    fn name(&self) -> &str { "FriendliAI" }
    fn id(&self) -> &str { "friendliai" }

    fn models(&self) -> Vec<ModelInfo> {
        vec![
            ModelInfo {
                id: "meta-llama-3.3-70b-instruct".into(),
                name: "Llama 3.3 70B (Friendli)".into(),
                provider: "FriendliAI".into(),
            ...
            ModelInfo {
                ...
                name: "Llama 3.1 8B (Friendli)".into(),
                provider: "FriendliAI".into(),
                context_window: 131_072,
            ...
            ModelInfo {
                ...
                name: "Qwen 2.5 72B (Friendli)".into(),
                provider: "FriendliAI".into(),
                context_window: 131_072,
                max_output_tokens: 8_192,
                input_cost_per_1k: 0.0007,
...
mod tests {
    use super::*;
    #[test]
    fn test_friendli_provider() { assert!(FriendliAIProvider::new("test-key").is_ok()); }
}
